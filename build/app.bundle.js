...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_forcejs__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_forcejs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_forcejs__);


let oauth = __WEBPACK_IMPORTED_MODULE_0_forcejs__["OAuth"].createInstance();
oauth.login()
    .then(oauthResult => {
        __WEBPACK_IMPORTED_MODULE_0_forcejs__["DataService"].createInstance(oauthResult);
        loadContacts();
    });

let loadContacts = () => {
    let service = __WEBPACK_IMPORTED_MODULE_0_forcejs__["DataService"].getInstance();
